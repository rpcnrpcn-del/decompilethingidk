Shader "Hidden/TerrainEngine/Splatmap/Lightmap-AddPass-Advanced-Lite Bumped" {
	...
	SubShader {
		Tags { "IGNOREPROJECTOR" = "true" "QUEUE" = "Geometry-99" "RenderType" = "Opaque" "SplatCount" = "4" }
		Pass {
			Name "FORWARD"
			Tags { "IGNOREPROJECTOR" = "true" "LIGHTMODE" = "ForwardBase" "QUEUE" = "Geometry-99" "RenderType" = "Opaque" "SHADOWSUPPORT" = "true" "SplatCount" = "4" }
		...
		Pass {
			Name "FORWARD"
			Tags { "IGNOREPROJECTOR" = "true" "LIGHTMODE" = "ForwardAdd" "QUEUE" = "Geometry-99" "RenderType" = "Opaque" "SplatCount" = "4" }
			Blend One One, One One
			ZClip Off
			ZWrite Off
			GpuProgramID 98803
		...
		Pass {
			Name "PREPASS"
			Tags { "IGNOREPROJECTOR" = "true" "LIGHTMODE" = "PrePassBase" "QUEUE" = "Geometry-99" "RenderType" = "Opaque" "SplatCount" = "4" }
		...
		Pass {
			Name "PREPASS"
			Tags { "IGNOREPROJECTOR" = "true" "LIGHTMODE" = "PrePassFinal" "QUEUE" = "Geometry-99" "RenderType" = "Opaque" "SplatCount" = "4" }
			Blend One One, One One
			ZClip Off
			ZWrite Off
			GpuProgramID 205943
		...
		Pass {
			Name "META"
			Tags { "IGNOREPROJECTOR" = "true" "LIGHTMODE" = "Meta" "QUEUE" = "Geometry-99" "RenderType" = "Opaque" "SplatCount" = "4" }
			ZClip Off
			Cull Off
			GpuProgramID 279870
			CGPROGRAM
