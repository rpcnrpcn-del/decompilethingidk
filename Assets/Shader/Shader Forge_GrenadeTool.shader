Shader "Shader Forge/GrenadeTool" {
	Properties {
	...
	SubShader {
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp4.xyz = tmp4.www * tmp4.xyz + _Color.xyz;
                tmp6.xyz = tmp4.xyz - float3(0.04, 0.04, 0.04);
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp3.xyz = tmp3.www * tmp3.xyz + _Color.xyz;
                tmp4.xyz = tmp3.xyz - float3(0.04, 0.04, 0.04);
                tmp4.xyz = _Metallic.xxx * tmp4.xyz + float3(0.04, 0.04, 0.04);
                tmp5.xyz = float3(1.0, 1.0, 1.0) - tmp4.xyz;
                tmp4.xyz = tmp5.xyz * tmp0.zzz + tmp4.xyz;
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp0.xyz = tmp0.www * tmp0.xyz + _Color.xyz;
                tmp1.xyz = tmp0.xyz - float3(0.04, 0.04, 0.04);
