Shader "Shader Forge/PBREmit" {
	Properties {
		...
		_Emit_From ("Emit_From", Color) = (1,0,0,1)
		_Emit_To ("Emit_To", Color) = (0,1,0.1310344,1)
		_Emit_Lerp ("Emit_Lerp", Range(0, 1)) = 0
	}
	SubShader {
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp6.xyz = tmp4.xyz * _Color.xyz;
                tmp4.xyz = tmp4.xyz * _Color.xyz + float3(-0.04, -0.04, -0.04);
                ...
                tmp2.xy = float2(1.0, 1.00001) - tmp2.xx;
                tmp3.zw = tmp2.xy * tmp2.xy;
                tmp3.zw = tmp3.zw * tmp3.zw;
                tmp2.xy = tmp2.xy * tmp3.zw;
                tmp8.xyz = tmp0.www - tmp4.xyz;
                tmp4.xyz = tmp2.xxx * tmp8.xyz + tmp4.xyz;
                ...
                tmp1.xyz = tmp0.www * _LightColor0.xyz + tmp5.xyz;
                tmp2.xyz = _Emit_To.xyz - _Emit_From.xyz;
                tmp2.xyz = _Emit_Lerp.xxx * tmp2.xyz + _Emit_From.xyz;
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp1.xyz = _Emit_To.xyz - _Emit_From.xyz;
                tmp1.xyz = _Emit_Lerp.xxx * tmp1.xyz + _Emit_From.xyz;
