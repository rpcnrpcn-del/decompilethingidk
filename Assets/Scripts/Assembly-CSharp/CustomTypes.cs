...
internal static class CustomTypes
{
	...
	internal static void Register()
	{
		...
		PhotonPeer.RegisterType(typeof(WhiteboardPenDrawingTool.ControlPoint), 68, WhiteboardPenDrawingTool.ControlPoint.Serialize, WhiteboardPenDrawingTool.ControlPoint.Deserialize);
		PhotonPeer.RegisterType(typeof(EraserDrawingTool.ControlPoint), 69, EraserDrawingTool.ControlPoint.Serialize, EraserDrawingTool.ControlPoint.Deserialize);
	}
