...
public class SteamVR_RenderModel : MonoBehaviour
{
	...
	{
		private static bool needsShutdown;

		private static bool failedLoadInterface;
		...
		public CVRRenderModels instance
		{
			get
			{
				if (_instance == null && !failedLoadInterface)
				{
					...
					if (_instance == null)
					{
						Debug.LogWarning("Failed to load IVRRenderModels interface version IVRRenderModels_005");
	...
	public void UpdateComponents()
	{
		...
		using (RenderModelInterfaceHolder renderModelInterfaceHolder = new RenderModelInterfaceHolder())
		{
			...
			for (int i = 0; i < transform.childCount; i++)
			{
				...
				if (instance.GetComponentState(renderModelName, child.name, ref pControllerState, ref controllerModeState, ref pComponentState))
				{
