...
public class PhotonStream
{
	...
	public void Serialize(ref byte myByte)
	{
		if (write)
		{
			writeData.Enqueue(myByte);
		}
		else if (readData.Length > currentItem)
		{
			myByte = (byte)readData[currentItem];
			currentItem++;
		}
	}
	...
	public void Serialize(ref double obj)
	{
		if (write)
		{
			writeData.Enqueue(obj);
		...
		{
			obj = (double)readData[currentItem];
			currentItem++;
		}
	}
