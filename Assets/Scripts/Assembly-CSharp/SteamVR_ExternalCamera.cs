...
public class SteamVR_ExternalCamera : MonoBehaviour
{
	...
	public void AttachToCamera(SteamVR_Camera vrcam)
	{
		if (cam == null)
		{
			...
			cam.HideLayer(Layers.HiddenInFirstPerson);
			cam.HideLayer(Layers.OverlayNotifications);
			TonemappingColorGrading tonemappingColorGrading = gameObject.AddComponent<TonemappingColorGrading>();
			tonemappingColorGrading.lut = SingletonMonoBehaviour<CameraRig>.Instance.Tonemapping.lut;
		}
